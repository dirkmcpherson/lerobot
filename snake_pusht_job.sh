...
DATA_DIR='./local/models' python lerobot/scripts/train.py policy=vqbet env=pusht dataset_repo_id='12out' hydra.job.name='12out' seed=43 wandb.project='vqbet_pusht'
DATA_DIR='./local/models' python lerobot/scripts/train.py policy=vqbet env=pusht dataset_repo_id='13out' hydra.job.name='13out' seed=13 wandb.project='vqbet_pusht'
DATA_DIR='./local/models' python lerobot/scripts/train.py policy=vqbet env=pusht dataset_repo_id='14out' hydra.job.name='14out' seed=21 wandb.project='vqbet_pusht'
DATA_DIR='./local/models' python lerobot/scripts/train.py policy=vqbet env=pusht dataset_repo_id='11out' hydra.job.name='11out' seed=4213 wandb.project='vqbet_pusht'